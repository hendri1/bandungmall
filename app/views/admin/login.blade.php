...
<html>
  <head>
    ...
    <title>Bandung Mall Admin | Log in</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        ...
        <a href="{{ URL::to('/') }}"><b>Admin Area</b></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Login ke Admin Area</p>
        <form action="{{ URL::to('admin/login/doLogin') }}" method="post">

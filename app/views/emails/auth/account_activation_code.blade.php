...
<body>
	<div style="margin:50px;padding:20px;border:1px solid #000">
    	<div>
   	    	<img src="{{asset('public/img/BandungMall-LOGO.png')}}" width="1250" height="180" />
            <hr />
        </div>
        <div>
        	<div>
            	<p>Anda telah terdaftar sebagai customer di bandungmall.co.id,<br />
					Silahkan klik <a href="{{$link}}">disini</a> untuk melakukan aktivasi account.<br /><br />

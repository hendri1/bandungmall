...
<div class="container main-container headerOffset globalPaddingBottom">
    ...
    <div class="container">
      <div class="hero-section-header ">
        <h3 class="section-title style2 text-center"><span>Hasil Pencarian</span></h3>
      </div>
    ...
    <div class="container">
      <div class="hero-section-header ">
        <h3 class="section-title style2 text-center"><span>User Also Searched</span></h3>
      </div>

      <div class="section-content">
        <div class="row has-equal-height-child">

          @forelse ($also_searched_products as $product)
            <div class="item itemauto col-lg-3 col-md-3 col-sm-6 col-xs-6">
              <div class="product">
                <div class="imageHover">
                  <div id="carousel-id-2" class="carousel slide carousel-fade" data-ride="carousel">
